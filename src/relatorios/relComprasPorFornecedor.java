 ...
 * @author lucas
 */
public class relComprasPorFornecedor extends javax.swing.JDialog {

    /**
     * Creates new form relComprasPorFornecedor
     */
    public relComprasPorFornecedor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Relatorio Total Compras Por Fornecedor");
    ...
    public void relCompras(){
         ...
         try {
                ...
                JasperDesign jd;
                String sql = null;
                jd = JRXmlLoader.load(".\\relatorios\\relComprasFornecedorTotal.jrxml");
                JasperReport jr= JasperCompileManager.compileReport(jd);
                sql="select tm.id_parceiro,\n" +
                    "        cast(sum(tm.total)as numeric (6,2)) as total,\n" +
                    "        tp.razao_social \n" +
                    "from tmovimento tm\n" +
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(relComprasPorFornecedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
