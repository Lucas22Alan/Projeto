 ...
 * @author Mk Solucoes
 */
public class frmRelLocacao extends javax.swing.JDialog {

    /**
     * Creates new form frmRelVendasTotalDiario
     */
    public frmRelLocacao(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.inicia();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Relatorio Locações Por Periodo");
    ...
    private void jPanel1ComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_jPanel1ComponentShown
     ...
     try{
         Date dataini,datafim=null;
            ...
            JasperDesign jd;
            jd = JRXmlLoader.load(".\\relatorios\\relLocacao.jrxml");
            JasperReport jr= JasperCompileManager.compileReport(jd);
            System.out.println(selecionado);
            String sql="select tl.data_retirou,tp.razao_social,tl.local,tl.responsavel,tr.descricao,tl.total from tlocacao tl\n" +
                        "left join tparceiros tp on tl.parceiro=tp.idparceiro\n" +
                        "left join testado_operacoes tr on tl.estado=tr.id\n" +
                        "where tl.data_retirou between ? and ? and tl.estado='"+selecionado+"'";
            
            if(ckTodos.isSelected()==true){
                sql="select tl.data_retirou,tp.razao_social,tl.local,tl.responsavel,tr.descricao,tl.total from tlocacao tl\n" +
                        "left join tparceiros tp on tl.parceiro=tp.idparceiro\n" +
                        "left join testado_operacoes tr on tl.estado=tr.id\n" +
                        "where tl.data_retirou between ? and ?";
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmRelLocacao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
