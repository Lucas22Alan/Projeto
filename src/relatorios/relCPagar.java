 ...
 * @author Rodrigo
 */
public class relCPagar extends javax.swing.JDialog {

    /**
     * Creates new form relCPagar
     */
    public relCPagar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     ...
     public void gerarRelatorio(){
        ...
        try { 
                ...
                JasperDesign jd;
                jd = JRXmlLoader.load(".\\relatorios\\reltTitulosPagar.jrxml");
                ...
                String sql="select tp.razao_social ,\n" +
                        ...
                        + "   join testado_operacoes top on top.id=tc.estado\n" +
                            " where pagar_receber='1' and tc.estado='"+estado+"' and "+filtro+" between '"+dataini+"' and '"+datafim+"'; ";
                 String sqltotalizado="select tp.razao_social ,\n" +
                        ...
                        + "           top.descricao as SITDOC \n" +
                            ...
                            " join tparceiros tp on tc.id_parceiro=tp.idparceiro \n"
                        + "   join testado_operacoes top on top.id=tc.estado\n" +
                            " where pagar_receber='1' and (tc.estado='"+estado+"' ) and "+filtro+" between '"+dataini+"' and '"+datafim+"' group by 1,3; ";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(relCPagar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
