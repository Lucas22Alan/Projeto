 ...
 * @author Mk Solucoes
 */
public class frmVendaCancelada extends javax.swing.JDialog {

    /**
     * Creates new form frmRelVendasTotalDiario
     */
    public frmVendaCancelada(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.inicia();
    }
    ...
    private void jPanel1ComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_jPanel1ComponentShown
     ...
     try{
         Date dataini,datafim=null;
            ...
            JasperDesign jd;
            jd = JRXmlLoader.load(".\\relatorios\\relVendaCancelada.jrxml");
            JasperReport jr= JasperCompileManager.compileReport(jd);
            
            String sql="select tm.id_mov, tm.numero_documento,tm.serie,tm.id_modelo, tm.data,tm.total,tm.dat_cancelado   from tmovimento tm\n" +
"                        where tm.data between ? and ? and tm.estado='3'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmVendaCancelada.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
