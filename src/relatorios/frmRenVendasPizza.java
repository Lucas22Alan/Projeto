 ...
 * @author lucas
 */
public class frmRenVendasPizza extends javax.swing.JDialog {
    ...
    int tipo=0;
    public frmRenVendasPizza(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public void inicia(int tipoRelatorio){
       this.tipo=tipoRelatorio;
       if(tipo==0){
           this.setTitle("Relatorio Vendas Por Tamanho De Pizza");
       }else if(tipo==1){
           this.setTitle("Relatorio Vendas Por Sabor De Pizza");
       }else if(tipo==2){
           this.setTitle("Relatorio Vendas Adicionais e Bordas");
       }
    ...
    public void gerarRelatorioTamanho(){
        try {
            ...
            JasperDesign jd;
            jd = JRXmlLoader.load(".\\relatorios\\relVendaPizza.jrxml");
            ...
            Logger.getLogger(frmRenVendasPizza.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmRenVendasPizza.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
