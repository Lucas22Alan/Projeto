 ...
 * @author Mk Solucoes
 */
public class FrmRelatorioSangrias extends javax.swing.JDialog {

    /**
     * Creates new form frmRelVendasTotalDiario
     */
    public FrmRelatorioSangrias(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.inicia();
    }
    ...
    private void initComponents() {
        ...
        jCheckBox1.setText("Totalizar Por descricao");
        jCheckBox1.setEnabled(false);

        cbTipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1- Sangria", "2- Suprimento" }));
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(ftFinal, javax.swing.GroupLayout.DEFAULT_SIZE, 95, Short.MAX_VALUE))))
    ...
    private void jPanel1ComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_jPanel1ComponentShown
     ...
     try{
         Date dataini,datafim=null;
            ...
            JasperDesign jd;
            jd = JRXmlLoader.load(".\\relatorios\\RelFinanceiroSangrias.jrxml");
            JasperReport jr= JasperCompileManager.compileReport(jd);
            
            String sql="select tc.data_lancamento,tc.id_movcx,iif(tc.valor_entrada>0,tc.valor_entrada,tc.valor_saida)as valor,tp.id_pdv,tc.motivo    from tmov_caixa tc\n" +
                        "join tcaixa_pdv tp on tp.id_caixa=tc.id_caixa\n" +
                        "where tc.data_lancamento between ? and ? and tc.entrada_saida= ?";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmRelatorioSangrias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
