 ...
 */
public class FrmMovOs extends javax.swing.JDialog {

    /**
     * Creates new form FrmMovOs
     */
    public FrmMovOs(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.inicia();
    }
    ...
    private void initComponents() {
        ...
        cbCliente.setFont(new java.awt.Font("Segoe UI Semilight", 0, 16)); // NOI18N
        ...
        cbSituacaoOs.setFont(new java.awt.Font("Segoe UI Semilight", 0, 16)); // NOI18N
        cbSituacaoOs.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "2 -Finalizado", "1- Em Andamento" }));
        cbSituacaoOs.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbSituacaoOsActionPerformed(evt);
            }
        });
        ...
        cbTipoFiltro.setFont(new java.awt.Font("Segoe UI Semilight", 0, 16)); // NOI18N
        cbTipoFiltro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Inicio", "Termino" }));
        cbTipoFiltro.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbTipoFiltroActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(cbSituacaoOs, javax.swing.GroupLayout.PREFERRED_SIZE, 224, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(27, 27, 27)
                                .addComponent(cbTipoFiltro, javax.swing.GroupLayout.PREFERRED_SIZE, 224, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(jLabel5)
                                .addGap(18, 18, 18)
                                .addComponent(cbCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 224, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void cbSituacaoOsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbSituacaoOsActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cbSituacaoOsActionPerformed

    private void cbTipoFiltroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbTipoFiltroActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cbTipoFiltroActionPerformed

    private void jPanel2ComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_jPanel2ComponentShown

    }//GEN-LAST:event_jPanel2ComponentShown
    public void inicia(){
        DefaultComboBoxModel tm = new DefaultComboBoxModel(listaplanosDAO.listaAtiradores("0").toArray());
        cbCliente.setModel(tm);
    ...
    public void gerarRelatorio(){
        ...
        String tipofiltro,tipodata,tipoestado,parceiro=null;
        String sql=null;
        dataini=clsaux.retornaData(ftInicial.getText());
        datafim=clsaux.retornaData(ftFinal.getText());
        tipofiltro=cbTipoFiltro.getSelectedItem().toString();
        tipoestado=clsaux.retornaId(cbSituacaoOs.getSelectedItem().toString());
        if (tipofiltro=="Inicio"){
            tipofiltro="data_entrada";
        }else if(tipofiltro=="Termino"){
            tipofiltro="data_saida";
        }
        if (ckTodos.isSelected()){
            if (ckTodos1.isSelected()){
                sql="select ts.id_ordem,tp.razao_social,ts.data_entrada,ts.data_saida,\n" +
                        "ts.subtotal,ts.desconto,ts.total,td.descricao\n" +
                        "from tordem_servico ts\n" +
                        "join tparceiros tp on ts.id_parceiro=tp.idparceiro\n" +
                        "join testado_operacoes td on ts.situacao_os=td.id\n" +
                        "where ts."+tipofiltro+" between '"+dataini+"'and'"+datafim+"'";
            } else {
                sql="select ts.id_ordem,tp.razao_social,ts.data_entrada,ts.data_saida,\n" +
                        "ts.subtotal,ts.desconto,ts.total,td.descricao\n" +
                        "from tordem_servico ts\n" +
                        "join tparceiros tp on ts.id_parceiro=tp.idparceiro\n" +
                        "join testado_operacoes td on ts.situacao_os=td.id\n" +
                        "where ts."+tipofiltro+" between '"+dataini+"'and'"+datafim+"' and ts.situacao_os='"+tipoestado+"'" ;
            }
        }else {
            parceiro=clsaux.retornaAposId(cbCliente.getSelectedItem().toString());
            if (ckTodos1.isSelected()){
                sql="select ts.id_ordem,tp.razao_social,ts.data_entrada,ts.data_saida,\n" +
                        "ts.subtotal,ts.desconto,ts.total,td.descricao\n" +
                        "from tordem_servico ts\n" +
                        "join tparceiros tp on ts.id_parceiro=tp.idparceiro\n" +
                        "join testado_operacoes td on ts.situacao_os=td.id\n" +
                        "where ts."+tipofiltro+" between '"+dataini+"'and'"+datafim+"' and ts.id_parceiro='"+parceiro+"'";
            } else {
                sql="select ts.id_ordem,tp.razao_social,ts.data_entrada,ts.data_saida,\n" +
                        "ts.subtotal,ts.desconto,ts.total,td.descricao\n" +
                        "from tordem_servico ts\n" +
                        "join tparceiros tp on ts.id_parceiro=tp.idparceiro\n" +
                        "join testado_operacoes td on ts.situacao_os=td.id\n" +
                        "where ts."+tipofiltro+" between '"+dataini+"'and'"+datafim+"' and ts.situacao_os='"+tipoestado+"' and ts.id_parceiro='"+parceiro+"'";
            }
        ...
        try {
            ...
            JasperDesign jd;
            jd = JRXmlLoader.load(".\\relatorios\\RelOsMovimentacao.jrxml");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmMovOs.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
