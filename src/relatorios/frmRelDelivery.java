 ...
 * @author lucas
 */
public class frmRelDelivery extends javax.swing.JDialog {
    ...
    int tipo=0;
    public frmRelDelivery(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public void gerarRelatorioEntregaBairro(){
        try {
            ...
            JasperDesign jd;
            jd = JRXmlLoader.load(".\\relatorios\\relDeliveryEntregaBairro.jrxml");
            JasperReport jr= JasperCompileManager.compileReport(jd);
            String sql="select td.bairro,td.taxa_entrega as valor,count (td.bairro) as quantidade, sum(td.taxa_entrega) as total from tdelivery td\n" +
                    "where td.retirada='Entregar' and td.estado_sistema=2 and td.data_pedido between '"+dataini+" 00:00' and '"+datafim+" 23:59'\n" +
            ...
            Logger.getLogger(frmRelDelivery.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmRelDelivery.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
