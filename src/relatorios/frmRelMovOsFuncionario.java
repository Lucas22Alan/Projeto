 ...
 * @author Rkochhann
 */
public class frmRelMovOsFuncionario extends javax.swing.JDialog {

    /**
     * Creates new form frmRelMovOsFuncionario
     */
    public frmRelMovOsFuncionario(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        inicia();
    }
    ...
    public void gerarRelatorio(){
        ...
        if (ckTodos.isSelected()){
            if (ckTodos1.isSelected()){
                sql="select\n"+
                    ...
                    "where a.id_os in\n"+
                      "(select b.id_ordem from tordem_servico b\n"+
                       "where b.data_saida between '"+dataini+"'and'"+datafim+"' and b.situacao_os='2')\n"+
                    "group by 1";
            } else {
                ...
                sql="select\n"+
                    ...
                    "where a.id_os in\n"+
                      "(select b.id_ordem from tordem_servico b\n"+
                       "where b.data_saida between '"+dataini+"'and'"+datafim+"' and b.situacao_os='2') and a.funcionario='"+funcionario+"'\n"+
                    "group by 1";
            }
        } else{
            servico=clsaux.retornaAposId(cbServicos.getSelectedItem().toString()).trim();
            if(ckTodos.isSelected()){
                sql="select\n"+
                    "a.funcionario\n"+
                    "from tos_item a\n"+
        ...
        try {
            ...
            jd = JRXmlLoader.load(".\\relatorios\\relMovOsUsuario.jrxml");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmRelMovOsFuncionario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
