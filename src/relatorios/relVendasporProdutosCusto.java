...
public class relVendasporProdutosCusto extends javax.swing.JDialog {

    /**
     * Creates new form relVendasporProdutos
     */
    public relVendasporProdutosCusto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.inicia();
    }
...
"                                         cast ((sum (ti.total)- sum((ti.quantidade)*tr.preco_custo))/ iif(sum(ti.cust_total)=0,1,sum(ti.cust_total)) *100 as numeric(5,2)) as porcentagem\n" +
"                                         from titens ti\n" +
...
"                                         and ti.codi_barra in ("+dados+")";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(relVendasporProdutosCusto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
