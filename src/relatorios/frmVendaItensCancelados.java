 ...
 * @author Mk Solucoes
 */
public class frmVendaItensCancelados extends javax.swing.JDialog {

    /**
     * Creates new form frmRelVendasTotalDiario
     */
    public frmVendaItensCancelados(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.inicia();
    }
    ...
    private void jPanel1ComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_jPanel1ComponentShown
     ...
     try{
         Date dataini,datafim=null;
            ...
            JasperDesign jd;
            jd = JRXmlLoader.load(".\\relatorios\\relVendaCanceladaItens.jrxml");
            JasperReport jr= JasperCompileManager.compileReport(jd);
            
            String sql="select ti.id_mov,tm.numero_documento,tm.id_modelo,tm.dat_finalizacao,ti.codi_barra,ti.quantidade, ti.total,ti.desc_fornecedor,tm.serie  from titens ti\n" +
                        "join tmovimento tm on ti.id_mov=tm.id_mov\n" +
                        "where (ti.estado=3 or tm.estado=3 ) and tm.dat_finalizacao between ? and ?";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmVendaItensCancelados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
