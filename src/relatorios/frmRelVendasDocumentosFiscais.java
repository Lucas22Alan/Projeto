 ...
 * @author Mk Solucoes
 */
public class frmRelVendasDocumentosFiscais extends javax.swing.JDialog {

    /**
     * Creates new form frmRelVendasTotalDiario
     */
    public frmRelVendasDocumentosFiscais(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.inicia();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Vendas Por Documentos Fiscais");
        ...
        cbTipoMov.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "55- Nfe", "65- Nfce", "99- Outros" }));
    ...
    private void jPanel1ComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_jPanel1ComponentShown
     ...
     try{
         Date dataini,datafim=null;
            ...
            JasperDesign jd;
            jd = JRXmlLoader.load(".\\relatorios\\relVendasDocFiscais.jrxml");
            JasperReport jr= JasperCompileManager.compileReport(jd);
            
            String sql="select tm.id_mov, tm.numero_documento,tm.serie,tm.id_modelo, tm.dat_finalizacao,tm.total,tm.chave_acesso,tn.cstat,tn.nfce_identificada  from tmovimento tm\n" +
                        "left join tnota_fiscal tn on tm.id_mov=tn.id_movimento\n" +
                        "where tm.dat_finalizacao between ? and ? and tm.estado='2' and tm.id_modelo='"+selecionado+"' and (tm.id_tipo=1 or tm.id_tipo=2)";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmRelVendasDocumentosFiscais.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
