 ...
 * @author Mk Solucoes
 */
public class frmRelDevolucao extends javax.swing.JDialog {

    /**
     * Creates new form frmRelVendasTotalDiario
     */
    public frmRelDevolucao(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.inicia();
    }
    ...
    private void jPanel1ComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_jPanel1ComponentShown
     ...
     try{
         Date dataini,datafim=null;
            ...
            JasperDesign jd;
            jd = JRXmlLoader.load(".\\relatorios\\relDevolucao.jrxml");
            JasperReport jr= JasperCompileManager.compileReport(jd);
            
            String sql="select ti.codi_barra as barra,tm.dat_finalizacao as data,ti.desc_fornecedor as descricao,ti.quantidade,ti.total from titens ti\n" +
                            "join tmovimento tm on ti.id_mov=tm.id_mov \n" +
                        "where tm.dat_finalizacao between ? and ? and (tm.id_tipo='10')and tm.estado='2' and ti.estado='2'" ;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmRelDevolucao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
