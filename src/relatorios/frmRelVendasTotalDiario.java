 ...
 * @author Mk Solucoes
 */
public class frmRelVendasTotalDiario extends javax.swing.JDialog {

    /**
     * Creates new form frmRelVendasTotalDiario
     */
    public frmRelVendasTotalDiario(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.inicia();
    }
    ...
    private void initComponents() {
        ...
        cbTipoMov.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1-Vendas", "2-Vendas Adm", "5-Venda Adm Rc", "6-Venda Ordem Servico" }));
    ...
    private void jPanel1ComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_jPanel1ComponentShown
     ...
     try{
         Date dataini,datafim=null;
            ...
            JasperDesign jd;
            jd = JRXmlLoader.load(".\\relatorios\\relVendasTotalDiario.jrxml");
            JasperReport jr= JasperCompileManager.compileReport(jd);
            
            String sql="select tm.data,sum(ti.total)as total , sum(ti.cust_total) as custo, sum(ti.total)- sum(ti.cust_total) as lucro from titens ti\n" +
                            "join tmovimento tm on ti.id_mov=tm.id_mov \n" +
                        "where tm.dat_finalizacao between ? and ? and (tm.id_tipo='"+selecionado+"')and tm.estado='2' and ti.estado='2'\n" +
                        "group by 1";
            
            if(ckTodos.isSelected()==true){
                sql="select tm.data,sum(ti.total)as total , sum(ti.cust_total) as custo, sum(ti.total)- sum(ti.cust_total) as lucro from titens ti\n" +
                                    "join tmovimento tm on ti.id_mov=tm.id_mov \n" +
                        "where tm.dat_finalizacao between ? and ? and (tm.id_tipo='1' or tm.id_tipo='2' or tm.id_tipo='5' or tm.id_tipo='6') and tm.estado='2' and ti.estado='2'\n" +
                        "group by 1";
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmRelVendasTotalDiario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
